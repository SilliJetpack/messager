...
if(message.content.startsWith(prefix +  "invite")) {
    ...
    .addField("Here", "[Click Me](https://discordapp.com/oauth2/authorize?client_id=488433937698258955&scope=bot&permissions=0)")
    .addField("OR the link only", "https://discordapp.com/oauth2/authorize?client_id=488433937698258955&scope=bot&permissions=0")
...
.addField("ℹ️ Description", "Hello, i am Messager, your most useless discord bot you can ever have, the only purpose i server is sending messages as 'emails' yet they're not real ones, you want to see what i can do? then type m!help, note that all cmds work also in DMs, since this bot is meant to be used in DMs")
.addField(":thinking: How do i work?", "It's simple! just do m!cemail <aname> and you're good to go! tell your friends what your fake email account is and they can spam your DMs with shitpost and trash! I will DM you when you receive something new.")
.addField("🤷 Do i even server a purpose?", "Yeah extremely good question tho, idfk if it's even worth sending messages through DMs using a bot but i'm here incase you want me")
